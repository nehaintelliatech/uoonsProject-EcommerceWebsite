...
const CardContainer2 = (props) => {
  ...
  return (
      ...
      <div className='flex flex-col w-[80%] items-center shadow-xl rounded-[16px] absolute top-[70px] p-3 my-3'>
      <div className='flex w-full justify-between items-center px-2'>
        
        <h1 className='text-[30px] font-bold'>StartUp India Recognised Product!</h1>
